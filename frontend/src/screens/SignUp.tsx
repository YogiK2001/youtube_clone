      ...
      <div className="w-full max-w-4xl bg-amber-50 border-4 border-black shadow-[8px_8px_0px_0px_#000] flex flex-col md:flex-row overflow-hidden">
        ...
        <div className="md:w-7/12 bg-amber-50 p-8 flex flex-col justify-center gap-4">
          ...
          <div className="relative">
            <textarea
              className="w-full border-2 border-black bg-white px-3 py-2 font-mono text-sm font-bold text-black placeholder-gray-400 focus:outline-none focus:bg-yellow-50 focus:border-red-600 shadow-[3px_3px_0px_0px_#000] resize-none transition-all"
